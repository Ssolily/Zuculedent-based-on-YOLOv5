...
def run(
    ...
    s = ("%22s" + "%11s" * 6) % ("Class", "Images", "Instances", "Procession", "Recall", "mAP50", "mAP50-95")
...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=r"E:\Dull_Tear_Joy\pests\yolov5\data\pests-colorandgray-pestmore-addeggs-v2\data.yaml", help="dataset.yaml path")
    parser.add_argument("--weights", nargs="+", type=str, default=r"E:\Dull_Tear_Joy\pests\yolov5\runs\train\yolov5l 需要补充验证\weights\best.pt", help="model path(s)")
